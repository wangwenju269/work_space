...
from core_agent.utils.logger import agent_logger as logger

from .action_parser import ActionParser
from .action_parser_factory import ActionParserFactory
from .agent_types import AgentType
from .llm import LLM
from .prompt import PromptGenerator
from .prompt.prompt_factory import PromptGeneratorFactory 
...
class AgentExecutor:
    ...
    def __init__(self,
        ...
        self.prompt_generator = PromptGeneratorFactory.get_prompt_generator(
                agent_type, llm, prompt_generator=prompt_generator, **kwargs)

        self.action_parser = ActionParserFactory.get_action_parser(
