...
parser.add_argument('--epoch_num', default=1, type=int, help="number of epochs")
parser.add_argument('--multi_gpu', default=1,action='store_true', help="ensure multi-gpu training")
